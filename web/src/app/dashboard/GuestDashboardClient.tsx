...
export default function GuestDashboardClient() {
    return (
        <div className="relative h-screen w-full overflow-hidden bg-zinc-950">
            ...
            <div className="absolute top-4 left-1/2 -translate-x-1/2 z-40 bg-black/60 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 text-white text-xs font-medium flex items-center gap-2 shadow-xl">
                <span>👀</span>
                <span>وضع الزائر (المشاهدة فقط)</span>
            </div>

            {/* 👇 Floating CTA Buttons */}
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center gap-4 w-full max-w-sm px-4">
                <motion.div
